  ...
  for(it= 0; it<nt; it++){
      ...
      for(ix=1; ix < nx-1; ix++){
        ...
        if(ord == 2 || ix == 1 || ix == nx-2 || iy ==1 || iy == ny-2){
          ...
          P1(ix,iy) = (2.0 + -5.0*V(ix,iy))*P2(ix,iy) - P1(ix,iy)
                      + 1.0*V(ix,iy)*(-1.0/12.0*(P2(ix+2,iy)+P2(ix-2,iy)+P2(ix,iy+2)+P2(ix,iy-2)) 
                                      + 4.0/3.0*(P2(ix+1,iy)+P2(ix-1,iy)+P2(ix,iy+1)+P2(ix,iy-1)) );
