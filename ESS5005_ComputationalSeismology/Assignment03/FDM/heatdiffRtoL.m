...
%plot gif with 2D contour
    ...
    for i=1:speedb:Nt
        ...
        if i==1
            imwrite(imind,cm,'heatdiffRtoL.gif','gif','LoopCount',inf,'DelayTime',1);
        else 
            if i==Nt
                imwrite(imind,cm,'heatdiffRtoL.gif','gif','WriteMode','append','DelayTime',1);
            else
                imwrite(imind,cm,'heatdiffRtoL.gif','gif','WriteMode','append','DelayTime',1/speeda);
            end
        end
    end
    close(fig);